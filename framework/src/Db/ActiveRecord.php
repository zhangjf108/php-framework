 ...
 *
 * To declare an ActiveRecord class you need to extend [[\Kerisy\Db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \Kerisy\Db\ActiveRecord
 * {
...
class ActiveRecord extends BaseActiveRecord
{
    ...
    {
        return Kerisy::make(ActiveQuery::className(), [get_called_class()]);
    }
    ...
    public static function tableName()
    {
        return '{{%' . Inflector::camel2id(StringUtil::basename(get_called_class()), '_') . '}}';
    }
    ...
    public function insert($runValidation = true, $attributes = null)
    {
        if ($runValidation && !$this->validate($attributes)) {
            Kerisy::info('Model not inserted due to validation error.', __METHOD__);
            return false;
        }
    ...
    public function update($runValidation = true, $attributeNames = null)
    {
        if ($runValidation && !$this->validate($attributeNames)) {
            Kerisy::info('Model not updated due to validation error.', __METHOD__);
            return false;
        }
