 ...
 * @since 2.0.6
 */
class ColumnSchemaBuilder extends Component
{
    ...
    /**
     * @var \Kerisy\Db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \Kerisy\Db\Connection $db the current database connection. See [[$db]].
