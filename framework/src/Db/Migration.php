 ...
 *
 * Migration is designed to be used together with the "Kerisy migrate" command.
 *
 ...
 * logic. The "Kerisy migrate" command manages all available migrations in an application.
 *
...
class Migration extends Component implements MigrationInterface
{
    ...
    public function execute($sql, $params = [])
    {
        ...
        if ($this->maxSqlOutputLength !== null) {
            $sqlOutput = StringUtil::truncate($sql, $this->maxSqlOutputLength, '[... hidden]');
        }
