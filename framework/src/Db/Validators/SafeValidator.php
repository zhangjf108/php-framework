 ...
 *
 * This class is required because of the way in which Kerisy determines whether a property is safe for massive assignment, that is,
 ...
 * override these internal values (especially things like database row ids), Kerisy assumes all values are unsafe for massive assignment
 ...
 * as a validation rule for that property. Although it has no functionality, it allows Kerisy to determine that the property is safe to copy.
 *
