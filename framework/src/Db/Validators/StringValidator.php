...
class StringValidator extends Validator
{
     ...
     * If this property is not set, [[\Kerisy\base\Application::charset]] will be used.
     */
    public $encoding;
    ...
    public function init()
    {
        ...
        if ($this->encoding === null) {
            $this->encoding = Kerisy::$app->charset;
        }
        if ($this->message === null) {
            $this->message = Kerisy::t('Kerisy', '{attribute} must be a string.');
        }
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = Kerisy::t('Kerisy', '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.');
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = Kerisy::t('Kerisy', '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.');
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual = Kerisy::t('Kerisy', '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.');
        }
    }
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        return 'Kerisy.validation.string(value, messages, ' . json_encode($options, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . ');';
    }
