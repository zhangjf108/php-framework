 ...
 * @since 2.0
 */
class QueryBuilder extends \Kerisy\Db\QueryBuilder
{
    /**
     ...
     * @param array $orderBy the order by columns. See [[\Kerisy\Db\Query::orderBy]] for more details on how to specify this parameter.
     * @param int $limit the limit number. See [[\Kerisy\Db\Query::limit]] for more details.
     * @param int $offset the offset number. See [[\Kerisy\Db\Query::offset]] for more details.
    ...
    protected function getAllColumnNames($modelClass = null)
    {
        ...
        /* @var $modelClass \Kerisy\Db\ActiveRecord */
     ...
     * @throws \Kerisy\Exception\InvalidConfigException
     * @throws \Kerisy\Db\Exception
     */
