...
use ArrayObject;
use ReflectionClass;
use Kerisy\Utils\Inflector;
use Kerisy\Utils\Arrayable;
use Kerisy\Utils\ArrayableTrait;
use Kerisy\DB\Validators\RequiredValidator;
use Kerisy\DB\Validators\Validator;
 ...
 *
 * @property \Kerisy\DB\Validators\Validator[] $activeValidators The Validators applicable to the current
 ...
 * @property ArrayObject|\Kerisy\DB\Validators\Validator[] $validators All the Validators declared in the model.
...
class Model extends Component implements \IteratorAggregate, \ArrayAccess, Arrayable
{
     ...
     *
     * The form name is mainly used by [[\Kerisy\widgets\ActiveForm]] to determine how to name
     ...
     * ```
     *
     * @return ArrayObject|\Kerisy\DB\Validators\Validator[] all the Validators declared in the model.
     */
     ...
     * @return \Kerisy\DB\Validators\Validator[] the Validators applicable to the current [[scenario]].
     */
     ...
     * [[\Kerisy\Validators\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     *
     * Note that when the validator has a conditional validation applied using
     * [[\Kerisy\Validators\RequiredValidator::$when|$when]] this method will return
