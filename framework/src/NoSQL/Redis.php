...
use Kerisy\NoSQL\Traits\RedisTrait;
...
class Redis extends Component
{
    ...
    public function init()
    {
        ...
        if (\Kerisy::$app->has('logException')) {
            $this->logger = \Kerisy::$app->get('logException');
        } else if (\Kerisy::$app->has('log')) {
    ...
    {
        $this->redis = static::createConnection($this->dsn, $this->options);
    ...
    public function __call($method, $args)
    {
        ...
        try {
            ...
            $this->logger->error($e->getMessage(), ['dsn' => $this->dsn, 'options' => $this->options]);
            $this->connect();
        }
