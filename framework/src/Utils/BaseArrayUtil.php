...
class BaseArrayUtil
{
     ...
     * ```php
     * // working with array
     * $username = \Kerisy\Utils\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \Kerisy\Utils\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \Kerisy\Utils\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \Kerisy\Utils\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \Kerisy\Utils\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \Kerisy\Utils\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = \Kerisy\Utils\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
     ...
     * [[\Kerisy\Exception\Application::charset]] will be used.
     ...
     * ];
     *
     * $result = \Kerisy\Utils\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \Kerisy\Utils\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \Kerisy\Utils\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
