...
PATTERN;
     ...
     * $query = (new \Kerisy\Db\Query)->from(['u' => 'user', 'profile']);
     *
     * // SELECT * FROM (SELECT * FROM `user` WHERE `active` = 1) `activeusers`;
     * $subquery = (new \Kerisy\Db\Query)->from('user')->where(['active' => true])
     * $query = (new \Kerisy\Db\Query)->from(['activeusers' => $subquery]);
     *
