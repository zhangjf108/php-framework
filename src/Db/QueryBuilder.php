...
class QueryBuilder extends Component
{
     ...
     * @param array|\Kerisy\Db\Query $columns the column data (name => value) to be inserted into the table or instance
     * of [[Kerisy\Db\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[Kerisy\Db\Query|Query]] is available since version 2.0.11.
    ...
    public function insert($table, $columns, &$params)
    {
        ...
        if ($columns instanceof \Kerisy\Db\Query) {
            ...
            foreach ($columns as $name => $value) {
                ...
                } elseif ($value instanceof \Kerisy\Db\Query) {
     ...
     *
     * @param \Kerisy\Db\Query $columns Object, which represents select query.
     * @param \Kerisy\Db\Schema $schema Schema object to quote column name.
     * @param array $params the parameters to be bound to the generated SQL statement. These parameters will
     * be included in the result with the additional parameters generated during the query building process.
     * @return array
    ...
    public function buildHashCondition($condition, &$params)
    {
        ...
        foreach ($condition as $column => $value) {
            if (ArrayUtil::isTraversable($value) || $value instanceof Query) {
                // IN condition
