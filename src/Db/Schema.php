...
abstract class Schema extends Component
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'Kerisy\Db\IntegrityException',
    ];
    /**
     * @var string column schema class
     * @since 2.0.11
     */
    public $columnSchemaClass = 'Kerisy\Db\ColumnSchema';
    ...
    {
        return Kerisy::make($this->columnSchemaClass);
    }
    ...
    public function refresh()
    {
        ...
        $cache = is_string($this->db->schemaCache) ? Kerisy::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\Kerisy\Db\Exception';
    ...
    protected function getTableMetadata($name, $type, $refresh)
    {
        ...
        if ($this->db->enableSchemaCache && !in_array($name, $this->db->schemaCacheExclude, true)) {
            $schemaCache = is_string($this->db->schemaCache) ? Kerisy::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
            if ($schemaCache instanceof AbstractCache) {
                $cache = $schemaCache;
            }
        }
