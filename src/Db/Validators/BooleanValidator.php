...
class BooleanValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = Kerisy::t('Kerisy', '{attribute} must be either "{true}" or "{false}".');
        }
    }
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        return 'Kerisy.validation.boolean(value, messages, ' . json_encode($options, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . ');';
    }
