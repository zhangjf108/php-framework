...
class ExistValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = Kerisy::t('Kerisy', '{attribute} is invalid.');
        }
    }
     ...
     * @return \Kerisy\db\ActiveQueryInterface the query instance
     */
    protected function createQuery($targetClass, $condition)
    {
        /* @var $targetClass \Kerisy\db\ActiveRecordInterface */
