 ...
 * - `captcha`: [[\Kerisy\captcha\CaptchaValidator]]
...
class Validator extends Component
{
    ...
    public static $builtInValidators = [
        'boolean' => 'Kerisy\DB\Validators\BooleanValidator',
        'date' => 'Kerisy\DB\Validators\DateValidator',
        'datetime' => [
            'class' => 'Kerisy\DB\Validators\DateValidator',
        ...
        'default' => 'Kerisy\DB\Validators\DefaultValueValidator',
        'double' => 'Kerisy\DB\Validators\NumberValidator',
        'each' => 'Kerisy\DB\Validators\EachValidator',
        'email' => 'Kerisy\DB\Validators\EmailValidator',
        'exist' => 'Kerisy\DB\Validators\ExistValidator',
        'file' => 'Kerisy\DB\Validators\FileValidator',
        'filter' => 'Kerisy\DB\Validators\FilterValidator',
        'image' => 'Kerisy\DB\Validators\ImageValidator',
        'in' => 'Kerisy\DB\Validators\RangeValidator',
        'integer' => [
            'class' => 'Kerisy\DB\Validators\NumberValidator',
            'integerOnly' => true,
        ],
        'match' => 'Kerisy\DB\Validators\RegularExpressionValidator',
        'number' => 'Kerisy\DB\Validators\NumberValidator',
        'required' => 'Kerisy\DB\Validators\RequiredValidator',
        'safe' => 'Kerisy\DB\Validators\SafeValidator',
        'string' => 'Kerisy\DB\Validators\StringValidator',
        'trim' => [
            'class' => 'Kerisy\DB\Validators\FilterValidator',
            'filter' => 'trim',
            'skipOnArray' => true,
        ],
        'unique' => 'Kerisy\DB\Validators\UniqueValidator',
        'url' => 'Kerisy\DB\Validators\UrlValidator',
        'ip' => 'Kerisy\DB\Validators\IpValidator',
    ];
    /**
     ...
     * @param \Kerisy\base\Model $model the data model to be validated.
    ...
    public static function createValidator($type, $model, $attributes, $params = [])
    {
        ...
        return Kerisy::createObject($params);
    }
     ...
     * @param \Kerisy\base\Model $model the data model being validated
    ...
    public function validate($value, &$error = null)
    {
        ...
        $params['attribute'] = Kerisy::t('Kerisy', 'the input value');
        if (is_array($value)) {
            $params['value'] = 'array()';
     ...
     * @param \Kerisy\base\Model $model the data model being validated
     * @param string $attribute the name of the attribute to be validated.
     * @param \Kerisy\web\View $view the view object that is going to be used to render views or view files
     ...
     * @see \Kerisy\widgets\ActiveForm::enableClientValidation
     */
     ...
     * @param \Kerisy\base\Model $model the model being validated
    ...
    /**
     * Formats a mesage using the I18N, or simple strtr if `\Kerisy::$app` is not available.
    ...
    {
        if (Kerisy::$app !== null) {
            return \Kerisy::$app->getI18n()->format($message, $params, Kerisy::$app->language);
        }
