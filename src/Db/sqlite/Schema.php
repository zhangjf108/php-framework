...
class Schema extends \Kerisy\Db\Schema
{
    ...
    protected function loadTableForeignKeys($tableName)
    {
        ...
        $foreignKeys = ArrayUtil::index($foreignKeys, null, 'table');
        ArrayUtil::multisort($foreignKeys, 'seq', SORT_ASC, SORT_NUMERIC);
        $result = [];
        foreach ($foreignKeys as $table => $foreignKey) {
            $result[] = new ForeignKeyConstraint([
                'columnNames' => ArrayUtil::getColumn($foreignKey, 'from'),
                'foreignTableName' => $table,
                'foreignColumnNames' => ArrayUtil::getColumn($foreignKey, 'to'),
    ...
    private function loadTableConstraints($tableName, $returnType)
    {
        ...
        foreach ($indexes as $index) {
            ...
            ArrayUtil::multisort($columns, 'seqno', SORT_ASC, SORT_NUMERIC);
            $result['indexes'][] = new IndexConstraint([
                'isPrimary' => $index['origin'] === 'pk',
                'isUnique' => (bool) $index['unique'],
                'name' => $index['name'],
                'columnNames' => ArrayUtil::getColumn($columns, 'name'),
            ]);
            if ($index['origin'] === 'u') {
